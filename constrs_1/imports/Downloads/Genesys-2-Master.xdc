...
## PMOD Header JA
set_property -dict {PACKAGE_PIN U27 IOSTANDARD LVCMOS33} [get_ports sclk]
set_property -dict {PACKAGE_PIN U28 IOSTANDARD LVCMOS33} [get_ports cs]
set_property -dict {PACKAGE_PIN T26 IOSTANDARD LVCMOS33} [get_ports mosi]
set_property -dict {PACKAGE_PIN T27 IOSTANDARD LVCMOS33} [get_ports miso]
...
connect_debug_port u_ila_0/probe11 [get_nets [list u_tx_payload_fifo/r_WR_INDEX0]]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {spi_m/ptm_transmitted_byte_counter[0]} {spi_m/ptm_transmitted_byte_counter[1]} {spi_m/ptm_transmitted_byte_counter[2]} {spi_m/ptm_transmitted_byte_counter[3]} {spi_m/ptm_transmitted_byte_counter[4]} {spi_m/ptm_transmitted_byte_counter[5]} {spi_m/ptm_transmitted_byte_counter[6]} {spi_m/ptm_transmitted_byte_counter[7]} {spi_m/ptm_transmitted_byte_counter[8]} {spi_m/ptm_transmitted_byte_counter[9]} {spi_m/ptm_transmitted_byte_counter[10]}]]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {u_w5500_axi_data_streamer/u_payload_fifo/r_FIFO_COUNT_reg[11]}]]
...
connect_debug_port u_ila_0/probe3 [get_nets [list {spi_m/ptm_transmitted_byte_counter[0]} {spi_m/ptm_transmitted_byte_counter[1]} {spi_m/ptm_transmitted_byte_counter[2]} {spi_m/ptm_transmitted_byte_counter[3]} {spi_m/ptm_transmitted_byte_counter[4]} {spi_m/ptm_transmitted_byte_counter[5]} {spi_m/ptm_transmitted_byte_counter[6]} {spi_m/ptm_transmitted_byte_counter[7]} {spi_m/ptm_transmitted_byte_counter[8]} {spi_m/ptm_transmitted_byte_counter[9]} {spi_m/ptm_transmitted_byte_counter[10]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 8 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list {rdata[0]} {rdata[1]} {rdata[2]} {rdata[3]} {rdata[4]} {rdata[5]} {rdata[6]} {rdata[7]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe7 [get_nets [list spi_m_n_12]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe11 [get_nets [list miso_IBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe12]
set_property port_width 1 [get_debug_ports u_ila_0/probe12]
connect_debug_port u_ila_0/probe12 [get_nets [list u_tx_payload_fifo/r_WR_INDEX0]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe13]
set_property port_width 1 [get_debug_ports u_ila_0/probe13]
connect_debug_port u_ila_0/probe13 [get_nets [list rlast]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe14]
set_property port_width 1 [get_debug_ports u_ila_0/probe14]
connect_debug_port u_ila_0/probe14 [get_nets [list RVALID]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe15]
set_property port_width 1 [get_debug_ports u_ila_0/probe15]
connect_debug_port u_ila_0/probe15 [get_nets [list spi_m/u_w5500_stream_manager/ptm_packet_done]]
