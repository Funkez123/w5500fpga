...
#                script (type 'axis_data_fifo_16_times_8bit.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axis_data_fifo_16_times_8bit xil_defaultlib.glbl -o axis_data_fifo_16_times_8bit_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axis_data_fifo_16_times_8bit_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axis_data_fifo_16_times_8bit_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axis_data_fifo_16_times_8bit_simv.daidir vcs_lib c.obj)
