...
#
# Script generated by Vivado on Mon Jan 13 08:57:03 +0100 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axis_data_fifo_16_times_8bit.sh
...
#
# Usage        : axis_data_fifo_16_times_8bit.sh
#                axis_data_fifo_16_times_8bit.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axis_data_fifo_16_times_8bit.sh [-reset_run]
#                axis_data_fifo_16_times_8bit.sh [-reset_log]
#                axis_data_fifo_16_times_8bit.sh [-help]
#
...
# script info
echo -e "axis_data_fifo_16_times_8bit.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axis_data_fifo_16_times_8bit.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_11 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_data_fifo_16_times_8bit xil_defaultlib.axis_data_fifo_16_times_8bit xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axis_data_fifo_16_times_8bit -key {Behavioral:sim_1:Functional:axis_data_fifo_16_times_8bit} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axis_data_fifo_16_times_8bit.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axis_data_fifo_16_times_8bit.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axis_data_fifo_16_times_8bit.sh [-help]\n\
Usage: axis_data_fifo_16_times_8bit.sh [-step]\n\
Usage: axis_data_fifo_16_times_8bit.sh [-lib_map_path]\n\
Usage: axis_data_fifo_16_times_8bit.sh [-reset_run]\n\
Usage: axis_data_fifo_16_times_8bit.sh [-reset_log]\n\
Usage: axis_data_fifo_16_times_8bit.sh [-keep_index]\n\
Usage: axis_data_fifo_16_times_8bit.sh [-noclean_files]\n\n\
