...
#
# Script generated by Vivado on Fri Dec 20 16:32:32 +0100 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_11 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_data_fifo_8bit xil_defaultlib.axis_data_fifo_8bit xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axis_data_fifo_8bit -key {Behavioral:sim_1:Functional:axis_data_fifo_8bit} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axis_data_fifo_8bit.wdb xsim.dir libdpi.so)
