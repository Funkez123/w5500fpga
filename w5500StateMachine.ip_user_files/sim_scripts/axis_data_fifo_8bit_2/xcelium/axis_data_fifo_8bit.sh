...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"../../../../w5500StateMachine.gen/sources_1/ip/axis_data_fifo_8bit/hdl" \
  ...
  xmvlog -work axis_infrastructure_v1_1_1 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../w5500StateMachine.gen/sources_1/ip/axis_data_fifo_8bit/hdl" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axis_data_fifo_v2_0_11 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../w5500StateMachine.gen/sources_1/ip/axis_data_fifo_8bit/hdl" \
  "../../../ipstatic/hdl/axis_data_fifo_v2_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../w5500StateMachine.gen/sources_1/ip/axis_data_fifo_8bit/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axis_data_fifo_8bit xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axis_data_fifo_8bit -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axis_data_fifo_8bit_sc.so .tmp_log xcelium_lib waves.shm c.obj)
