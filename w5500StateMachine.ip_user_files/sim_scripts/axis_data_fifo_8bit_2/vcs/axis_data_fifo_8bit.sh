...
#
# Script generated by Vivado on Wed Mar 12 15:29:27 +0100 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axis_data_fifo_8bit.sh
...
#
# Usage        : axis_data_fifo_8bit.sh
#                axis_data_fifo_8bit.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axis_data_fifo_8bit.sh [-reset_run]
#                axis_data_fifo_8bit.sh [-reset_log]
#                axis_data_fifo_8bit.sh [-help]
#
...
#                script (type 'axis_data_fifo_8bit.sh -help' for more information).
#
...
# script info
echo -e "axis_data_fifo_8bit.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axis_data_fifo_8bit.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"../../../../w5500StateMachine.gen/sources_1/ip/axis_data_fifo_8bit/hdl" \
  ...
  vlogan -work axis_infrastructure_v1_1_1 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../w5500StateMachine.gen/sources_1/ip/axis_data_fifo_8bit/hdl" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axis_data_fifo_v2_0_11 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../w5500StateMachine.gen/sources_1/ip/axis_data_fifo_8bit/hdl" \
  "../../../ipstatic/hdl/axis_data_fifo_v2_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../w5500StateMachine.gen/sources_1/ip/axis_data_fifo_8bit/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axis_data_fifo_8bit xil_defaultlib.glbl -o axis_data_fifo_8bit_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axis_data_fifo_8bit_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axis_data_fifo_8bit_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axis_data_fifo_8bit_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axis_data_fifo_8bit.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axis_data_fifo_8bit.sh [-help]\n\
Usage: axis_data_fifo_8bit.sh [-step]\n\
Usage: axis_data_fifo_8bit.sh [-lib_map_path]\n\
Usage: axis_data_fifo_8bit.sh [-reset_run]\n\
Usage: axis_data_fifo_8bit.sh [-reset_log]\n\
Usage: axis_data_fifo_8bit.sh [-keep_index]\n\
Usage: axis_data_fifo_8bit.sh [-noclean_files]\n\n\
